        ...
        <section id="hero" className="hero">
          ...
          <div>
            ...
            <div className="hero-links">
              <a
                href="https://github.com/starsang45"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/in/victorsang/"
                target="_blank"
                rel="noopener noreferrer"
              >
                LinkedIn
              ...
              <a
                href="https://docs.google.com/document/d/11d8kFb0qy8OWbm0way6ZJd-JRbS5d8IT0x6DP9TJQug/edit?usp=sharing"
                target="_blank"
              >
                Resume
              </a>
        ...
        <section id="experience">
          ...
          <div className="card experience-card">
            ...
            <p className="exp-role">
              Digital Content Manager/Frontend engineer
            </p>
          </div>
        ...
        <section id="projects">
          ...
          <div className="card project-card">
            <div className="project-header">
              <a
                href="https://stream-lift-508.notion.site/AI-Driven-Lead-Scoring-CRM-Automation-System-2b8f84fdd9bc8012bdaff98315dc87c5?source=copy_link"
                target="_blank"
                rel="noopener noreferrer"
                className="project-link"
              >
                AI-Driven Lead Scoring & CRM Automation
              </a>
          ...
          <div className="card project-card">
            <div className="project-header">
              ...
              <span className="tech-inline">
                {" "}
                · javascript · selenium · GA4 · GSC · aws s3{" "}
              </span>
            </div>
            <p className="project-desc">
              launched and optimized the kbs+ ott platform with automated seo
              pipelines and performance dashboards
            </p>
          </div>
        </section>
        {/* Projects */}
        <section id="projects">
          ...
          <div className="card project-card">
            <div className="project-header">
              ...
              <span className="tech-inline">
                {" "}
                · typescript · javascript(ES6+) · node · express · jest
              </span>
            </div>
            <p className="project-desc">
              lightweight 2d audio visualizer react library
          ...
          <div className="card project-card">
            <div className="project-header">
              ...
              <span className="tech-inline">
                {" "}
                · javascript · tailwindCSS · jest · mongoDB
              </span>
            </div>
            <p className="project-desc">
              scalable NASA APOD image live archive
            </p>
          </div>
          ...
          <div className="card project-card">
            <div className="project-header">
              ...
              <span className="tech-inline">
                {" "}
                · typescript · react · tailwindCSS · express · jest · mongoDB
              </span>
            </div>
          ...
          <div className="card project-card">
            <div className="project-header">
              ...
              <span className="tech-inline">
                {" "}
                · aws SQS · azure · python Boto3 · mySQL
              </span>
            </div>
            <p className="project-desc">
